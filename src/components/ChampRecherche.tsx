...
export function ChampRecherche({ className = '' }: { className?: string }) {
  return (
    <div className={`biseau border border-white/[0.09] bg-[#0b0f1c]/85 px-4 py-4 backdrop-blur-sm sm:px-6 sm:py-6 ${className}`}>
        ...
        <div className="champ-neon">
          <div className="flex items-center gap-3 px-5 py-3.5 sm:px-7 sm:py-4">
            <input
              ...
              className="w-full bg-transparent font-corps text-[15px] text-texte sm:text-[16px] outline-none placeholder:text-texte-faible"
            />
            <button
              type="submit"
              aria-label="Search"
            ...
            >
              <svg viewBox="0 0 24 24" className="h-[23px] w-[23px]" fill="none" aria-hidden>
